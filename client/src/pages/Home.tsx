...
export default function Home() {
  ...
  function startOnlineMatch() { if (!isAuthenticated) { setLoginModalOpen(true); return; } if (onlineEntry === "private-create") createPrivate.mutate({ scoreLimit: 100 }); else if (onlineEntry === "private-join") joinPrivate.mutate({ inviteCode }); else joinOnline.mutate({ scoreLimit: 100 }); }
